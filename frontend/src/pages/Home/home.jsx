...
import { SearchMobile, DivLogo, LogoNome, MyDiv, MyH3, NenhumProduto, ScrollContainer, MyUl, MyButton } from './styled';
  ...
  return (
    <div>
      ...
      <div>
        ...
        {produtosFiltrados.length === 0 && <NenhumProduto>Nenhum produto encontrado.</NenhumProduto>}
